...
def build_list_by_subscription_request(
    ...
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/providers/Microsoft.AlertsManagement/actionRules')
...
def build_list_by_resource_group_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AlertsManagement/actionRules')
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
...
def build_get_by_name_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AlertsManagement/actionRules/{alertProcessingRuleName}')
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, 'str', min_length=1),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, 'str'),
...
class AlertProcessingRulesOperations(object):
    ...
    :type models: ~alerts_management_client.models
    ...
    def list_by_subscription(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.AlertProcessingRulesList"]
        """List all alert processing rules in a subscription.

        :keyword api_version: Api Version. The default value is "2021-08-08". Note that overriding this
         default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either AlertProcessingRulesList or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~alerts_management_client.models.AlertProcessingRulesList]
    ...
    def get_by_name(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.AlertProcessingRule"
        ...
        :rtype: ~alerts_management_client.models.AlertProcessingRule
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def create_or_update(
        ...
        resource_group_name,  # type: str
        alert_processing_rule_name,  # type: str
        alert_processing_rule,  # type: "_models.AlertProcessingRule"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.AlertProcessingRule"
        ...
        :type alert_processing_rule: ~alerts_management_client.models.AlertProcessingRule
        :keyword api_version: Api Version. The default value is "2021-08-08". Note that overriding this
         default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def update(
        ...
        resource_group_name,  # type: str
        alert_processing_rule_name,  # type: str
        alert_processing_rule_patch,  # type: "_models.PatchObject"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.AlertProcessingRule"
        ...
        :type alert_processing_rule_patch: ~alerts_management_client.models.PatchObject
        :keyword api_version: Api Version. The default value is "2021-08-08". Note that overriding this
         default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
