...
class AlertsOperations:
    ...
    async def meta_data(
        ...
        **kwargs: Any
        ...
        :type identifier: str or ~alerts_management_client.models.Identifier
        :keyword api_version: Api Version. The default value is "2019-05-05-preview". Note that
         overriding this default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: AlertsMetaData, or the result of cls(response)
        :rtype: ~alerts_management_client.models.AlertsMetaData
    ...
    def get_all(
        ...
        **kwargs: Any
        ...
        :param monitor_service: Filter by monitor service which generates the alert instance. Default
         value is select all.
        :type monitor_service: str or ~alerts_management_client.models.MonitorService
        :param monitor_condition: Filter by monitor condition which is either 'Fired' or 'Resolved'.
         Default value is to select all.
        :type monitor_condition: str or ~alerts_management_client.models.MonitorCondition
        :param severity: Filter by severity.  Default value is select all.
        :type severity: str or ~alerts_management_client.models.Severity
        :param alert_state: Filter by state of the alert instance. Default value is to select all.
        :type alert_state: str or ~alerts_management_client.models.AlertState
        ...
        :type sort_by: str or ~alerts_management_client.models.AlertsSortByFields
        ...
        :type sort_order: str or ~alerts_management_client.models.SortOrder
        ...
        :type time_range: str or ~alerts_management_client.models.TimeRange
    ...
    async def get_by_id(
        ...
        **kwargs: Any
        ...
        :rtype: ~alerts_management_client.models.Alert
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def change_state(
        ...
        **kwargs: Any
        ...
        :type new_state: str or ~alerts_management_client.models.AlertState
        :keyword api_version: Api Version. The default value is "2019-05-05-preview". Note that
         overriding this default value may result in unsupported behavior.
        :paramtype api_version: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def get_history(
        ...
        **kwargs: Any
        ...
        :rtype: ~alerts_management_client.models.AlertModification
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def get_summary(
        ...
        **kwargs: Any
        ...
        :type groupby: str or ~alerts_management_client.models.AlertsSummaryGroupByFields
        ...
        :rtype: ~alerts_management_client.models.AlertsSummary
        :raises: ~azure.core.exceptions.HttpResponseError
        """
