...
class AlertProcessingRulesOperations:
    """AlertProcessingRulesOperations async operations.
    ...
    def list_by_subscription(
        self,
        **kwargs: Any
    ) -> AsyncIterable["_models.AlertProcessingRulesList"]:
        ...
        :return: An iterator like instance of either AlertProcessingRulesList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~alerts_management_client.models.AlertProcessingRulesList]
